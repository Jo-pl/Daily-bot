...
let discordBot = new Bot({client : client,config : config});
...
function embededWeather(body){
    return new Discord.MessageEmbed()
        ...
        .addFields(
            { name: 'Min', value : `${body.main.temp_min} °C`,inline : true },
            { name: 'Current', value: `${body.main.temp} °C`, inline: true },
            { name: 'Max', value : `${body.main.temp_max} °C`, inline: true },
        )
        .addField('\u200B','\u200B')
        .addFields(
            { name: 'Wind Speed',value :  `${body.wind.speed} m/s`,inline : true},
            { name: 'Humidity', value : `${body.main.humidity} %`,inline : true },
            { name: 'Pressure', value: `${body.main.pressure} hPa`, inline: true }
        )
        .setTimestamp();
}
